...
<body>
    ...
    <div class="wrapper">
        ...
        <img src="images/main.jpg" alt="Courses" class="main_bg">

        <h4 class="heading center z-depth-3">Our Trainers</h4>
        ...
        // Display Course
        $get_pro = "select * from trainers where trainer_name like '%$search%'order by rand() LIMIT 8";
        ...
        while($row_pro = mysqli_fetch_array($run_pro)) {
            ...
            echo "
                <div class='col l3 m3 s3 course_grid z-depth-2'>
            ...
            <div id='$trainer_id' class='modal'>
                <div class='modal-content'>
                    <h4 class='center heading customer_account_page enrollment_form' style='margin-top: 0px;'>Training Schedule</h4>
                        <input type='text' name='trainer_id' value='$trainer_id' style='display: none;' />
                        <table>
                        <tr>
                        <td> <input type='text' style='color: #0d0d0d' value='Trainer Name : $trainer_name' disabled class='center'/></td>
                        <td> <input type='text' style='color: #0d0d0d' value='Package Name : $package_name' disabled class='center'/></td>
                        <td> <input type='text' style='color: #0d0d0d' value='Trainer Fee : $training_fee' disabled class='center'/> </td>
                        </tr>
                        ...
                        if ($session_id == 3)
                        {
                            ...
                            <table>
                                ...
                                <tr>
                                    ...
                                    echo "
                                    <td><input type='submit' class='enroll_btn' name='enroll_gym' value='Enroll' /></td>";
                                    }
        ...
        ?>
        <a href="trainers.php" class="view_all right">View All</a>
        </div>
